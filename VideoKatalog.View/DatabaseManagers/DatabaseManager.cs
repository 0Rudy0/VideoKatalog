...
namespace Video_katalog {
    public class DatabaseManager {
        static SqlConnection connection = new SqlConnection(ComposeConnectionString.ComposeInitial());
        ...
        public static ObservableCollection<Movie> FetchMovieList (ObservableCollection<Genre> genreList, ObservableCollection<Audio> audioList,
            ...
            string SqlCommandGetAudio = "SELECT * FROM [Movie-Audio]";
            ...
            //**** AUDIO ****
            command = new SqlCommand (SqlCommandGetAudio, connection);
            reader = command.ExecuteReader ();
            while (reader.Read ()) {
                int movieID = (int) reader["movieID"];
        ...
        public static ObservableCollection<WishMovie> FetchWishMovieList (ObservableCollection<Person> personList, ObservableCollection<Genre> genreList) {
            ...
            string SqlCommandGetMovies = "SELECT * FROM [WishMovie] ORDER BY name";
            string SqlCommandGetCast = "SELECT * FROM [WishMovie-Cast] ORDER BY actorNum";
            string SqlCommandGetDirectors = "SELECT * FROM [WishMovie-Director] ORDER BY directorNum";
            string SqlCommandGetGenres = "SELECT * FROM [WishMovie-Genre] ORDER BY genreNum";
            SqlCommand command;
            SqlDataReader reader;
        ...
        public static ObservableCollection<SerieSeason> FetchSerieSeasonList (ObservableCollection<Serie> serieList, ref int counter) {
            ...
            SqlDataReader reader = slqCMNDGetSeasons.ExecuteReader ();
            while (reader.Read ()) {
        ...
        public static ObservableCollection<SerieEpisode> FetchSerieEpisodeList (ObservableCollection<SerieSeason> seasonList, ObservableCollection<Language> languageList,
            ...
            slqCMNDGetEpisodes = new SqlCommand (getEpisodeAudio, connection);
            reader = slqCMNDGetEpisodes.ExecuteReader ();
            while (reader.Read ()) {
        ...
        public static ObservableCollection<HomeVideo> FetchHomeVideosList (ObservableCollection<Category> categoryList, ObservableCollection<Camera> cameraList,
            ...
            command = new SqlCommand (getHomeVideosCommand, connection);
            reader = command.ExecuteReader ();
            ...
            command = new SqlCommand (getHomeVideosAudioCommand, connection);
            reader = command.ExecuteReader ();
            ...
            command = new SqlCommand (getHomeVideoCamermansCommand, connection);
            reader = command.ExecuteReader ();
            ...
            command = new SqlCommand (getHomeVideoPersonsCommand, connection);
            reader = command.ExecuteReader ();
        ...
        public static ObservableCollection<WishHomeVideo> FetchWishHomeVideoList (ObservableCollection<Person> personList, ObservableCollection<Category> categoryList,
            ...
            if (connection.State == ConnectionState.Open)
                ...
                connection.Open ();
            string SqlCommandGetHVs = "SELECT * FROM [WishHomeVideo]";
            string SqlCommandGetPersons = "SELECT * FROM [WishHV-Person] ";
            string SqlCommandGetCamermans = "SELECT * FROM [WishHV-Camerman]";
            SqlCommand command;
            SqlDataReader reader;

            #region Main

            command = new SqlCommand (SqlCommandGetHVs, connection);
            reader = command.ExecuteReader ();
            while (reader.Read ()) {
            ...
            command = new SqlCommand (SqlCommandGetPersons, connection);
            reader = command.ExecuteReader ();
            while (reader.Read ()) {
                int personID = (int) reader["personID"];
            ...
            command = new SqlCommand (SqlCommandGetCamermans, connection);
            reader = command.ExecuteReader ();
            while (reader.Read ()) {
                int camermanID = (int) reader["camermanID"];
                int wishID = (int) reader["wishHVID"];
        ...
        public static ObservableCollection<Audio> FetchAudioList (ObservableCollection<Language> languageList) {
            ...
            string SqlCommandAudio = "SELECT * FROM Audio";
            SqlCommand command = new SqlCommand (SqlCommandAudio, connection);
            SqlDataReader reader = command.ExecuteReader ();
        ...
        public static Settings FetchSettings () {
            ...
            SqlCommand SqlCommandGetSettings = new SqlCommand (getSettingsCommand, connection);
            SqlDataReader reader = SqlCommandGetSettings.ExecuteReader ();
            reader.Read ();
            try {
        ...
        public static ObservableCollection<Category> FetchCategories () {
            ...
            SqlCommand command = new SqlCommand (getCategoriesCommand, connection);
            SqlDataReader reader = command.ExecuteReader ();
            while (reader.Read ()) {
        ...
        public static List<PersonType> FetchPersonTypes () {
            ...
            command = new SqlCommand ("SELECT * FROM PersonType", connection);
            reader = command.ExecuteReader ();
            while (reader.Read ()) {
        ...
        static int GetIDOfLastEntry (string tableIDName, string tableName) {
            ...
            SqlCommand SqlCommandGetEntry = new SqlCommand (retreiveString, connection);
            SqlDataReader reader = SqlCommandGetEntry.ExecuteReader ();
            reader.Read ();
        ...
        static int ExecuteCommandAndGetID (SqlCommand SqlCommand, string tableIDName, string tableName) {
            int id;
            bool wasClosed = true;
            if (connection.State == ConnectionState.Open)
                wasClosed = false;
